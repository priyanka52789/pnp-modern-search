        ...
        DomHelper.forEach(nodes, ((index, el) => {
            el.addEventListener("click", (event) => {
                ...
                if (url) {
                    ...
                    //     display="block"
                    //     position="relative" />;
                    let ifrm = <iframe width="100%" height="761" src="https://apttus.seismic.com/Link/Content/NCkLbBsJr9G02EqSXNsfYs8Q" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>;

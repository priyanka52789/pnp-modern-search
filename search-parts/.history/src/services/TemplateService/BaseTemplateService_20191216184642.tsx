    ...
    private static _initDocumentPreviews() {
        ...
        DomHelper.forEach(nodes, ((index, el) => {
            el.addEventListener("click", (event) => {
                ...
                debugger;
                if (url) {
                    let ifrm = <Iframe url="http://www.youtube.com/embed/xDMP3i36naA"
                        width="450px"
                        height="450px"
                        id="myId"
                        ...
                        display="block"
                        position="relative" />;
                    // <iframe width="100%" height="761" src="https://apttus.seismic.com/Link/Content/NCkLbBsJr9G02EqSXNsfYs8Q" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
